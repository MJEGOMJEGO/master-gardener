...
puts "Creating tasks..."
Task.create!(plant: bernard, action: water_ficus, max_date: '2018-12-13', status: "pending")
...
Task.create!(plant: sophie, action: water_caoutchouc, max_date: '2018-12-13', status: "pending")
...
Task.create!(plant: rené, action: water_cactus, max_date: '2018-12-13', status: "pending")
...
Task.create!(plant: albert, action: water_amaryllis, max_date: '2018-12-13', status: "pending")
