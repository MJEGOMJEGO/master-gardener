...
feed_amaryllis      = Action.create!(code: 'feed', name: 'feed', points: 350, specie: amaryllis, sentence: 'I am hungry, feed me.', frequency_in_days: 40)
...
feed_cactus      = Action.create!(code: 'feed', name: 'feed', points: 350, specie: cactus, sentence: 'I am hungry, feed me.', frequency_in_days: 40)
...
feed_caoutchouc     = Action.create!(code: 'feed', name: 'feed', points: 350, specie: caoutchouc, sentence: 'I am hungry, feed me.', frequency_in_days: 40)
...
feed_ficus     = Action.create!(code: 'feed', name: 'feed', points: 350, specie: ficus, sentence: 'I am hungry, feed me.', frequency_in_days: 40)
...
feed_pachystachys     = Action.create!(code: 'feed', name: 'feed', points: 350, specie: pachystachys, sentence: 'I am hungry, feed me.', frequency_in_days: 40)
