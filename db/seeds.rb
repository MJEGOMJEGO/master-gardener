...
feed_guzmania          = Action.create!(code: 'feed', name: 'feed', points: 25, specie: guzmania, frequency_in_days: 40 )
pot_guzmania           = Action.create!(code: 'pot', name: 'pot', points: 250, specie: guzmania, frequency_in_days: 80 )
exposure_guzmania      = Action.create!(code: 'exposure', name: 'exposure', points: 150, specie: guzmania, frequency_in_days: 40 )
...
feed_spathiphyllum          = Action.create!(code: 'feed', name: 'feed', points: 25, specie: spathiphyllum, frequency_in_days: 40 )
pot_spathiphyllum           = Action.create!(code: 'pot', name: 'pot', points: 250, specie: spathiphyllum, frequency_in_days: 80 )
exposure_spathiphyllum      = Action.create!(code: 'exposure', name: 'exposure', points: 150, specie: spathiphyllum, frequency_in_days: 40 )
...
feed_gardenia               = Action.create!(code: 'feed', name: 'feed', points: 25, specie: gardenia, frequency_in_days: 40 )
pot_gardenia                = Action.create!(code: 'pot', name: 'pot', points: 250, specie: gardenia, frequency_in_days: 80 )
exposure_gardenia           = Action.create!(code: 'exposure', name: 'exposure', points: 150, specie: gardenia, frequency_in_days: 40 )
