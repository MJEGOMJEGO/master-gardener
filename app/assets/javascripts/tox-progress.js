    ...
    setTimeout(function () {
        if (progress > 50) {
            ...
            setTimeout(function () { // more then half round
                ...
                // element.querySelector('.radial-mask-3').style.background = 'linear-gradient(to right, #FF8C00, #40E0D0)';
                // element.querySelector('.radial-outer').style.background = 'linear-gradient(to right, #40E0D0, #FF8C00)';
                if (+progress === 100) {
